...
def header_record(Latitude, Longitude, ID, Platform, Elevation, Bogus, Date):
    ...
    dict_header['Name'                ] = str_A40_Front_Space(ID)
    ...
    dict_header['IsSounding'          ] = '         T'   #	Logical flag: true if observation has multiple levels                         # logical 10
    ...
    dict_header['SLP-QC'              ] = '-888888.00000      0'                     # F13.5 I7
